$.post('./?r=sales-api/sales-detail-line', {
  'time': '4'
}, function(json) {
  if (json) {
            ...
            if (_cityData) {
              ...
              for (var i = 0; i < _cityData.length; i++) {
                while (_cityData[i] == data[1]) {
                  return '本月销量情况：<br/>' + data[1] + '分布' + citynum[i] + '袋 <br/>本市占比' + toDecimal((citynum[i] / dataLength) * 100) + '%;'
                }
              }
              return '本地区还没有开放';
            }
            ...
            if (provinceData) {
              for (var i = 0; i < provinceData.length; i++) {
                ...
                while (provinceData[i] == data[1] + '省') {
                  return '本月销量情况：<br/>' + data[1] + '分布' + provincenum[i] + '袋 <br/>全国占比' + toDecimal((provincenum[i] / dataLength) * 100) + '%;'
                }
              }
              return '本地区还没有开放';
            }
