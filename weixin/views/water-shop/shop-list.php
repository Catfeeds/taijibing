...
<div id="content">
    ...
    <div class="search_box_c">
        ...
        <div class="search_input_c">
            <div class="search_input radius">
                ...
                <input id="search_key" class="search_key" type="text" placeholder="输入商铺名称"
    ...
    <div id="manual_loc" style="display:none;">
        ...
        <div>
             <div  class="address_list" style="position:fixed;top:80px;width:100%;height:100%;overflow: scroll;padding-bottom:80px;z-index: 100;background-color: #fff">
            <ul class="flags_list" style='background-color: #fff'>
            </ul>
        </div>
    ...
    <div style="margin-top:120px;border-top:1px solid #e8e8e8;display:none;" id="emptyView">
        ...
        <!-- <p style="text-align:center;margin-top:10px;"><img src="/static/images2/WechatIMG5.png" style="width:107px;height:auto;"/></p> -->
    </div>
...
<script>
    ...
    var app = null;
    var coffeeType = sessionStorage.getItem("coordinate");
    var lat='';
    var lng='';
    var lat=<?=$lat?>;
    var lng=<?=$lng?>;
        ...
        .wait(function () {
            ...
            app = {
                ...
                query: function () {
                    ...
                    var url = "/index.php/water-shop/get-all-shop-data?lat=" + this.lat + "&lng=" + this.lng;
                ...
                updatePageWithoutLoc:function(data) {
                    ...
                    for (var index = 0; index < data.length; index++) {
                       ...
                       if(item.image1.indexOf("7xpcl7.com2.z0.glb.qiniucdn.com") != -1 ){
                         ...
                         var liStr = ' <a href="/index.php/water-shop/agent-shop?agent_id=' + item.agent_id + '&category_id=' +category_id +'&lat=' +lat +'&lng=' +lng +'"> <li>' +
