...
<body>
    <div id="container">
        ...
        <div id="gridContainer">
            ...
            <div class="grid_item  hide" style=";position:relative;border-bottom: 1px #f3f3f3 solid;">
            ...
            <div class="grid_item hide" style="position:relative;border-right: 1px #f3f3f3 solid;">
            ...
            <div class="grid_item hide  level5" style="position:relative;border-right: 1px #f3f3f3 solid;">
            ...
            <div class="grid_item hide quipment" style="position:relative;border-top: 1px #f3f3f3 solid;">
                <a href="/index.php/agent/investor">
                    <div style="left:50%;margin-left:-57px;position:relative;width:114px;">
                        <img src="/static/images/server_icon.png" style="display:inline-block;margin-top:20px;width:40px;height:40px;margin-right:10px;"/>
                        <span style="position:absolute;top:30px;">投资设备</span>
                    </div>
                </a>
            </div>
            <div class="grid_item  user_ad" style="position:relative;">
    ...
    <script type="text/javascript">
        $(function(){
           ...
           var info = localStorage.getItem('userInfo');
            ...
            $("#Name").text(infoi.result.name)

             if(infoi.result.level==5){
                    $(".level5").css("display","none")
                    $(".quipment").css({"display":"block","borderRight":"1px #f3f3f3 solid;"})
                    $(".user_ad").css({"display":"block","borderTop":"1px #f3f3f3 solid;"})
