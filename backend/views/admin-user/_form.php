    ...
    <div class="col-sm-12">
        <div class="ibox">
            ...
            <div class="ibox-content">
                ...
                <?= $form->field($model['model'], 'password')->passwordInput(['maxlength' => 512])->label('登陆密码') ?>
                <?= $form->field($model['model'], 'repassword')->passwordInput(['maxlength' => 512])->label('确认密码') ?>
...
<!--                        </div>-->
                        ...
                        <input id="lng" name="User[lng]" type="text" class="baseinput" style="width: 80px"/>
...
<!--                        </div>-->
                        ...
                        <input id="lat" name="User[lat]" type="text" class="baseinput" style="width: 80px"/>
