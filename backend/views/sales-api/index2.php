...
<head>
  ...
  <!-- <link rel="stylesheet" href="./static/css/sales-volume/index.css?v=1.1"/> -->
    <link rel="stylesheet" href="./static/css/sales-volume/index.css?v=1.1"/>
  <link rel="stylesheet" type="text/css" href="./static/css/sales-api/sales-api.css"></head>
...
<div style="width:100%;border-top: 1px solid #292834;margin-top: 20px;    background: #292834;padding-top:20px;">
...
<div style="  position: relative;margin: auto; width: 100%;text-align: center; height: 200px;">
...
<script>
  ...
  $("#IsTurnOut").chosen({no_results_text: "没有找到",disable_search: true}); //初始化chosen
  ...
  //   alert(4)
  //      $("#page_size").trigger("chosen:updated");
...
function   rendering(parameter){
           ...
           success: function (data) {
                ...
                var sort=0;
                 if(parameter.sort){
                  ...
                  dev_listdata(objdata.users,sort)
                 paging(total)
  ...
  var page_size = $('#page_size option:selected').val()
       ...
       // var  connectTxt=$(".connect_date").attr('column')||'';
        var time1subDate=  $("#time1sub").val();
   var time2subDate=  $("#time2sub").val();
...
console.log(role_id)
function   dev_listdata(data,sort){
    var tableTheadOneData   =['序号','用户姓名','联系电话','设备编号','地址','用户类型','总销量'];
    var tableTheadTwoData   =['序号','姓名','联系电话','设备编号','服务中心','用户类型','总销量'];
    var tableTheadThreeData =['序号','姓名','联系电话','设备编号','地区','用户类型','总销量'];
    var tableTheadFourData  =['序号','姓名','联系电话','设备编号','运营中心','地区','用户类型','总销量'];
    var tableTheadFiveData  =['序号','姓名','联系电话','设备编号','运营中心','地区','用户类型','总销量'];
    // console.log(1)


// 序号  姓名  联系电话  设备编号  运营中心  地区  用户类型  总销量
// 序号  姓名  联系电话  设备编号  地区  用户类型  总销量
