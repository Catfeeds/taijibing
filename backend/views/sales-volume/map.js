function  map(mapProvincebox,mapCitybox,progressBar,_CityBar,mapProvinceNUm,mapmapCityNUM) {

       console.log(_CityBar)
          ...
          if (mt == 'china') {
            ...
            option.tooltip.formatter = function(data) {
                ...
                for (var i = 0; i < mapCitybox.length; i++) {
                  while (mapmapCityNUM[i] == data[1]) {
                    return '本月销量情况：<br/>' + data[1] + '销量' + mapCitybox[i] + '袋 <br/>本市占比' + _CityBar[i]+ '%'
                  }
                }
                return '本地区还没有开放';
              }
            ...
            // option.tooltip.formatter = '设备分布情况：<br/>{b}分布888台<br/>全国占比50%';
              option.tooltip.formatter = function(data) {
                ...
                for (var i = 0; i < mapProvincebox.length; i++) {
                  while (mapProvinceNUm[i] == data[1] + '省') {
