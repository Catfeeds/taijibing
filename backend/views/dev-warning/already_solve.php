...
<div class="wrapper wrapper-content">
    ...
    <div style="margin-bottom:10px;"  class="condition" >
        <form method="post" action="/index.php?r=dev-warning/already-solve">
...
// console.log(where_datas)
        ...
        //排序
                $('#sort').click(function(){
                    ...
                    $(this).attr('href','./?r=dev-warning/already-solve&sort='+sort+'&content='+content+'&province='+province+'&city='+city+'&area='+area+'&selecttime='+selecttime+'&per-page='+page_size);
...
&nbsp;&nbsp;&nbsp;&nbsp;<a href='./?r=dev-warning/already-solve' id='butn'>确定</a></span>
</dev>"
