...
<div class="wrapper wrapper-content">
    ...
    <div style="margin-bottom:10px;"   class="condition" >
        <form method="post" action="/index.php?r=dev-warning/already-handle">
            <span style="padding-left:10px;"><label>搜索内容:</label><input type="text" placeholder="编号、类型、级别" id="content" name="content" value="<?=$content?>"/></span>
...
// alert(4)
        //排序
                $('#sort').click(function(){
                    ...
                    $(this).attr('href','./?r=dev-warning/already-handle&sort='+sort+'&content='+content+'&province='+province+'&city='+city+'&area='+area+'&selecttime='+selecttime+'&per-page='+page_size);
...
&nbsp;&nbsp;&nbsp;&nbsp;<a href='./?r=dev-warning/already-handle' id='butn'>确定</a></span>
</dev>"
