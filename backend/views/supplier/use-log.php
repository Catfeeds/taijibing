...
<!--    <a href="./?r=logic-user/factory-list">返回</a>-->
  ...
  <form method="post" action="/index.php?r=supplier/use-log">
      ...
      <input style="padding:0 10px;margin-left: 100px;    margin-top: 0px;" type="submit" value="查询" id="btn"/>                    <button type="text"  class="btn " id="removerSub">清空条件</button>
  </form>
        ...
        <table class="table table-hover" style="text-align: center;">
          ...
          <th style="width: 5%" id="sort" data="1">序号</th>
            ...
            <!-- <th>商品规格</th> -->
            <th>商品规格 </th>
             <th><a id="sort" data="Amount">使用条码</a></th>
             <th><a id="sort2" data="LeftAmount">剩余条码</a></th>
            <th><a id="sort3"  data="StartTime">使用时间</a></th>
            </thead>
            <tbody id='tableData'>
...
var time2sub=select_where.start_time;
 ...
 // console.log(searchParameters)
  ...
  $.post("./index.php?r=supplier/use-log-page", searchParameters, function(data){
       layer.close(ii); 
      ...
      var sales_detail=data.form_datas;
           ...
           if(typeof(sales_detail)=='string'){
           sales_detail=jQuery.parseJSON(sales_detail);
           }
