...
<style type="text/css" media="screen">
    ...
    <div class="wrapper wrapper-content">
        <div style="margin-bottom:10px;" class="condition" >
            <form action="/index.php?r=dev-investor/list" method="post">
                <span>
                	<label>名称:</label>
                	<input type="text" placeholder="请输入名称" id="username" name="username" value="<?=$username?>"/> 
                </span>
                ...
                <input type="submit" class="btn" value="查询"  id="btn" />
            </form>
        </div>
        <table class="table table-hover">
            ...
            <th style="width: 8%">投资详情</th>
            <th style="width: 8%">投资设置</th>
            </thead>
            <tbody>
            <?php
            $str='';
            ...
            if($role_id==1){
                foreach($model as $key=>$val)
                {
                    $str.= "<tr>
                        ...
                        <td>".$val["RowTime"]."</td>
                        <td><a href='./?r=dev-investor/see&id=".$val["Id"]."&name=".$val["Name"]."'>查看</a></td>
                        <td><a href='./?r=dev-investor/set-investment&id=".$val["Id"]."&name=".$val["Name"]."'>添加/修改</a></td>
                        </tr>";
                    $no++;
                }
                echo $str;
...
$(".table  td a").click(function(){
    ...
    var Urlobj = encodeURIComponent('province='+province+'&city='+city+'&area='+area+'&username='+username+'&mobile='+mobile);
    $(this).attr('href',_thisURl+"&Url="+Urlobj);
       ...
       addressResolve(data,province,city,area)
        ...
        $('#sort').click(function(){
            ...
            $(this).attr('href','./?r=dev-investor/list&sort='+sort+'&username='+username+'&mobile='+mobile+'&province='+province+'&city='+city+'&area='+area);
...
<?php
echo "";
echo "<dev style='float:left;margin-top: 22px;margin-left: 50px'>每页显示：<select type='text' name='page_size' id='page_size' style='width:50px;min-width:50px'>
...
&nbsp;&nbsp;&nbsp;&nbsp;<span style='margin-left: auto'>第：<input style='width: 50px;border-radius:4px' type='text' id='pages' name='pages' value='$page'>  页
&nbsp;&nbsp;&nbsp;&nbsp;<a href='./?r=dev-investor/list' id='butn'>确定</a></span>
</dev>"
?>
<script>
