...
<table class="table" style="background-color: #292834;text-align: center;">
   ...
   <tbody>
    ...
    <tr class="relatively" >
      <td class="name " colspan="" rowspan="4"  style="text-align:center;vertical-align:middle;">同期  <i class="compareHover glyphicon glyphicon-question-sign" style="color: #1d1f23" >
                ...
                <div style="background-color: #292834; color: #fff">
                       <div class="title">
                         ...
                         <!-- 时间容器 -->
                                ...
                                <select id='IsTurnOut' style="min-width: 50px;">  
...
<div class="container-fluid" style="background-color: #32323e;padding:0px; margin-left: 0px ;padding-top: 20px;color:#fff">
         ...
         <div class="selection pull-left" style='margin-left: 30px;    margin-left: 20px;'>
          ...
          <div style="clear:both; "></div>
                             <!-- 搜索容器 -->
             <div class="selection pull-left" id="searchbg" style='position:relative;    margin: 15px 0;margin-left: 20px;width: 100%;'>
...
$("#method").click(function() {
  var methodOneData   ='[{"Name":"用户姓名"},{"Tel":"联系电话"},{"DevNo":"设备编号"},{"GoodsName":"设备商品型号"},{"BrandName":"设备品牌"},{"agentFname":"服务中心"},{"agentYname":"运营中心"},{"Province":"省"},{"City":"市"},{"Area":"区"},{"UseType":"购水套餐"},{"CustomerType":"用户类型"},{"ActiveTime":"激活时间"}]';

 var methodTwoData   ='[{"Name":"服务中心"},{"Tel":"联系电话"},{"agentYname":"运营中心"},{"Province":"省"},{"City":"市"},{"Area":"区"},{"family_sales":"家庭用户"},{"company_sales":"公司用户"},{"group_sales":"集团用户"},{"other_sales":"其它"},{"total_sales":"总设备数量"}]';

  var methodThreeData ='[{"Name":"运营中心"},{"Tel":"联系电话"},{"Province":"省"},{"City":"市"},{"Area":"区"},{"family_sales":"家庭用户"},{"company_sales":"公司用户"},{"group_sales":"集团用户"},{"hotel_sales":"酒店"},{"other_sales":"其它"},{"total_sales":"总设备数量"}]';

var methodFourData  ='[{"Name":"设备厂家"},{"Tel":"联系电话"},{"Province":"省"},{"City":"市"},{"Area":"区"},{"family_sales":"家庭用户"},{"company_sales":"公司用户"},{"group_sales":"集团用户"},{"hotel_sales":"酒店"},{"other_sales":"其它"},{"total_sales":"总设备数量"}]';

var methodFiveData  ='[{"Name":"设备投资商"},{"Tel":"联系电话"},{"Province":"省"},{"City":"市"},{"Area":"区"},{"family_sales":"家庭用户"},{"company_sales":"公司用户"},{"group_sales":"集团用户"},{"hotel_sales":"酒店"},{"other_sales":"其它"},{"total_sales":"总设备数量"}]';

var methodSixData   ='[{"Name":"酒店中心"},{"Tel":"联系电话"},{"Province":"省"},{"City":"市"},{"Area":"区"},{"total_sales":"总设备数量"}]';

var methodSevenData  ='[{"Name":"片区中心"},{"Tel":"联系电话"},{"Province":"省"},{"City":"市"},{"Area":"区"},{"family_sales":"家庭用户"},{"company_sales":"公司用户"},{"group_sales":"集团用户"},{"hotel_sales":"酒店"},{"other_sales":"其它"},{"total_sales":"总设备数量"}]';
// alert(activeNum)
 ...
 window.location.href="./?r=dev-statistics/datas&state="+activeNum+"&starttime="+time1subDate+"&offset=0&limit="+total+"&endtime="+time2subDate+"&search="+searchp+"&title_column="+title_column;

})

</script>
<script type="text/javascript" src="/static/js/dev-statistics/common.js?v=1 "></script>
<script type="text/javascript" src="/static/js/dev-statistics/index.js?v=2.1  "></script>
