...
(function($, window, document, undefined) {
  ...
  //对Paging的实例对象添加公共的属性和方法
    ...
    $(document).on('.navdata li',function(){
         alert(5)
    })
      ...
      me.element.on('click', 'a,.shoPpage .dropdown-menu li', function() {
        if(me.options.totalSize<=0){
        
                 return;
        }
         // alert(me.options.totalSize)
  ...
  paging = function(options) {
     // console.log(options)
     return new Paging( $("#page"), options);
  }
