(function($, window, document, undefined) {
	...
	Paging.prototype = {
		...
		creatHtml: function() {
			...
			content += "<span class='shoPpage' style=''> 本页显示<span>&nbsp; <select  class= 'Jumpdisplay' style='height:30px;    padding-right: 30px;border-color: #393E45; '> "
		...
		bindEvent: function() {
			...
			me.element.on('change', '.Jumpdisplay', function() {
				var Jumpnumpval = $(this).val()
