        ...
        for (var i = 0; i < data.length; i++) {
          ...
          if (num == 2) {
            if (data[i]) {
              ...
              var html = '  <tr><td>' + w + '</td><td class="Name"> <a href="./index.php?r=sales-api/index&role_id=' + objdata.total + '&LoginName=' + data[i].LoginName + '">' + data[i].Name + '</a></td><td>' + data[i].Tel + '</td><td>' + data[i].parentname + '</td><td>' + data[i].Province + '-' + data[i].City + '-' + data[i].Area + '</td>' +
