            ...
            // alert('添加成功');
 			layer.alert('添加成功', {
			  ...
			  ,closeBtn: 0
			   ...
			   window.location.replace("/index.php?r="+page_url);
			});
...
displayDate='inline-block'
    ...
    var itemStr=' <div class="item" id="item'+currentIndex+'" itemid="100" num="'+currentIndex+'">'+
        ...
        '<a href="javascript:void(0);"  class="delGoodType" style="margin-left:25px;display:'+displayDate+';height:25px;line-height: 25px;"><img src="/static/images3/guanbi.png" alt=""></a>'+
        '</div>'+
